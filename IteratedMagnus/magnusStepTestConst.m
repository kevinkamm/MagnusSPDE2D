...
T=1;
dtMagnusLog=1e-4;
% for dT = 0.001:0.001:0.1
for dT = unique([T./(2:1:100),T./(2.^(1:10))])
    ...
    xExactMagnus1={};
    fExactMagnus1={};
    nBlowupsExactMagnus1={};
    xExactMagnus2={};
    fExactMagnus2={};
    nBlowupsExactMagnus2={};
    xExactMagnus3={};
    fExactMagnus3={};
    nBlowupsExactMagnus3={};
...
%             end
    ...
    root=[pwd, '/' ,'Results'];
    matRoot=[root,'/','StepTest'];
    mkDir(matRoot)
    if useMagnus1
        stepTest.Magnus1.ctime=ctimeMagnus1Total;
        stepTest.Magnus1=addAbsError(stepTest.Magnus1,'Exact',errAbsAvgExactMagnus1{end});
        stepTest.Magnus1=addRelError(stepTest.Magnus1,'Exact',errDisExactMagnus1{end});
    ...
    if useMagnus2
        ...
        stepTest.Magnus2=addAbsError(stepTest.Magnus2,'Exact',errAbsAvgExactMagnus2{end});
        stepTest.Magnus2=addRelError(stepTest.Magnus2,'Exact',errDisExactMagnus2{end});
    ...
    if useMagnus3
        ...
        stepTest.Magnus3=addAbsError(stepTest.Magnus3,'Exact',errAbsAvgExactMagnus3{end});
        stepTest.Magnus3=addRelError(stepTest.Magnus3,'Exact',errDisExactMagnus3{end});
