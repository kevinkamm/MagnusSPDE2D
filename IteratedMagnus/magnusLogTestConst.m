...
%             end
    ...
    root=[pwd, '/' ,'Results'];
    matRoot=[root,'/','LogTest'];
    mkDir(matRoot)
    if useMagnus1
        logTest.Magnus1.ctime=ctimeMagnus1Total;
        logTest.Magnus1=addAbsError(logTest.Magnus1,'Exact',errAbsAvgExactMagnus1{end});
        logTest.Magnus1=addRelError(logTest.Magnus1,'Exact',errDisExactMagnus1{end});
        logTest.Magnus1.T=T;
        logTest.Magnus1.dt=dT;
        logTest.Magnus1.nx=nx;
        logTest.Magnus1.nv=nv;
        logTest.Magnus1.M=M;
        logTest.Magnus1.dtLog=dtMagnusLog;
        logTest.Magnus1.kappas=kappas;
    end
    if useMagnus2
        logTest.Magnus2.ctime=ctimeMagnus2Total;
        logTest.Magnus2=addAbsError(logTest.Magnus2,'Exact',errAbsAvgExactMagnus2{end});
        logTest.Magnus2=addRelError(logTest.Magnus2,'Exact',errDisExactMagnus2{end});
        logTest.Magnus2.T=T;
        logTest.Magnus2.dt=dT;
        logTest.Magnus2.nx=nx;
        logTest.Magnus2.nv=nv;
        logTest.Magnus2.M=M;
        logTest.Magnus2.dtLog=dtMagnusLog;
        logTest.Magnus2.kappas=kappas;
    end
    if useMagnus3
        logTest.Magnus3.ctime=ctimeMagnus3Total;
        logTest.Magnus3=addAbsError(logTest.Magnus3,'Exact',errAbsAvgExactMagnus3{end});
        logTest.Magnus3=addRelError(logTest.Magnus3,'Exact',errDisExactMagnus3{end});
        logTest.Magnus3.T=T;
        logTest.Magnus3.dt=dT;
        logTest.Magnus3.nx=nx;
        logTest.Magnus3.nv=nv;
        logTest.Magnus3.M=M;
        logTest.Magnus3.dtLog=dtMagnusLog;
        logTest.Magnus3.kappas=kappas;
    end
    delFile([matRoot,'/',fileName,'.mat'])
    save([matRoot,'/',fileName,'.mat'],'logTest')
end
disp('Done')
