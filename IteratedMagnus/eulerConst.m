function ut=eulerConst(TTi,T,Neuler,dWeuler,Dx,Dv,Dxx,Dvv,H,Fx,Fv,Gxx,Gxv,Gvv,Sx,Sv,phi,varargin)
...
for tk=1:1:Neuler-1
    ...
    utTemp=...
        ...
        (Sx.*leftMult(Dx,utTemp)+...
        Sv.*rightMult(utTemp,Dv')).*dWeuler(:,:,tk,:);
end
if Neuler==TTi(ti)
    ut(:,:,ti,:)=utTemp;
end
